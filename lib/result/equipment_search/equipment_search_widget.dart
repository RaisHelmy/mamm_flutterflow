                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Autocomplete<String>(
                              ...
                              optionsBuilder: (textEditingValue) {
                                ...
                                return [
                                  'JS/PNWR/AE02/AA/CT01',
                                  'JS/PGRG/AE03/AA/CT01',
                                  'JS/PSAK/AE04/AA/CT02',
                                  'JS/TBIN/AA15/AA/CT02'
                                ].where((option) {
                          ...
                          Padding(
                            ...
                            child: Autocomplete<String>(
                              ...
                              onSelected: (String selection) {
                                setState(() => _model.textFieldSelectedOption3 =
                                    selection);
                                FocusScope.of(context).unfocus();
                              },
                              fieldViewBuilder: (
                                ...
                                if (_model.textController3.text != null &&
                                  ...
                                  if (_model.textController2.text != null &&
                                    ...
                                    _model.getequipmentbyserialno1 =
                                      ...
                                      serialNo: _model.textController2.text,
                                    );
                                    setState(() {
                                    ...
                                    if (_model.textController1.text != null &&
                                      ...
                                      if ((_model.apiResultlbk?.succeeded ??
                                          true)) {
                                        setState(() {
                                          FFAppState().listequipmentbyserialno =
                                              getJsonField(
                                            (_model.apiResultlbk?.jsonBody ??
                                                ''),
                                            r'''$[:]''',
                                          )!
                                                  .toList()
